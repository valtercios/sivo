...
<div class="card">
    <div class="card-header">
        ...
        <br>
        <p class="text-subtitle text-muted" style="display: inline-block; margin-bottom: -10px;">Escolha um corpo abaixo para prosseguir com o cadastro do laudo.</p>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-12">
...
<script>
    function selecionarCorpo(){
        ...
        if(corpoId){
            window.location.href = "{{ route('laudos.create') }}/"+corpoId;
        }
    }
</script>
