...
<body>
    <div id="main">
        ...
        <div id="conteudo">
            ...
            <div style="font-weight:bold;">
                ESCOLARIDADE: <h4 class="linha-campo"
                    style=" font-weight: bold;display:inline-block; width: 76%; font-weight: normal; position: relative; top: 5px;">
            ...
            <div style="font-weight: bold">
                D. NASC.: @if($corpo->natimorto == 0)<h4 class="linha-campo" style="font-weight: bold; display:inline-block; width: 9%; font-weight: normal; position: relative; top: 5px;">
                    {{ \Carbon\Carbon::parse($corpo->data_nascimento)->format('d/m/Y') }}</h4>
                @else
                    <h4 class="linha-campo" style="font-weight: bold; display:inline-block; width: 11%; font-weight: normal; position: relative; top: 9px;">
                    NATIMORTO</h4>
                @endif
            ...
            @if ($corpo->laudoInfo->historico != null)
                <pre style="min-height: 180px;" class="area-texto">{{ $corpo->laudoInfo->historico ?? '-' }}</pre>
            @endif
            <br>
                ...
                <div>
                    ...
                    <span style="margin-left: 36%;">
                        @if (!empty($corpo->laudoInfo->created_at))
                            DATA:<span class="linha-campo">
                                {{ \Carbon\Carbon::parse($corpo->laudoInfo->created_at)->format('d/m/Y') }}
                            </span>
                            HORA:<span class="linha-campo">
                                {{ \Carbon\Carbon::parse($corpo->laudoInfo->created_at)->format('H:i') }}
                            </span>
                        @endif
                    </span>
            ...
            @if ($corpo->laudoInfo->causa_b)
                ...
                <div style="min-height: 300px; page-break-inside: avoid;">
                    ...
                    <div class="titulo"
                        style="border-top: 3px solid  black; text-align:left; width: 108.8%; position: relative; left: -18px; top: 5px;">
                        <span style="margin-left: 3px;">CAUSA DA MORTE: B</span>

                    </div>

                    <pre class="area-texto">{{ $corpo->laudoInfo->causa_b->descricao ?? '-' }}</pre>

                </div>
            @endif

            @if ($corpo->laudoInfo->causa_c)
                <div class="titulo"
                    style="border-top: 3px solid  black; text-align:left; width: 103.5%; position: relative; left: -3px; top: 0px;">
                </div>
                <div style="min-height: 300px; page-break-inside: avoid;">
                    ...
                    <div class="titulo"
                        style="border-top: 3px solid  black; text-align:left; width: 108.8%; position: relative; left: -18px; top: 5px;">
                        <span style="margin-left: 3px;">CAUSA DA MORTE: C</span>

                    </div>

                    <pre class="area-texto">{{ $corpo->laudoInfo->causa_c->descricao ?? '-' }}</pre>

                </div>
            @endif

            @if ($corpo->laudoInfo->causa_d)
                <div class="titulo"
                    style="border-top: 3px solid  black; text-align:left; width: 103.5%; position: relative; left: -3px; top: 0px;">
                </div>
                <div style="min-height: 300px; page-break-inside: avoid;">
                    ...
                    <div class="titulo"
                        style="border-top: 3px solid  black; text-align:left; width: 108.8%; position: relative; left: -18px; top: 5px;">
                        <span style="margin-left: 3px;">CAUSA DA MORTE D</span>

                    </div>

                    <pre class="area-texto">{{ $corpo->laudoInfo->causa_d->descricao ?? '-' }}</pre>
        ...
        <!-- FIM CONTEUDO -->
        @if ($corpo->laudoInfo->exame_macroscopia != null)
        ...
        @endif
        @if ($corpo->laudoInfo->exame_conclusoes != null)
            <div class="titulo"
                style="border-top: 3px solid  black; text-align:left; width: 103.5%; position: relative; left: -3px; top: 0px;">
            </div>
            <div style="min-height: 300px; page-break-inside: avoid;">
        ...
        @endif
        <div
            style="text-align: center; position: relative; right: 80px; bottom: 0; display: flex; flex-direction: column; align-items: center;">
            <div class="assinatura">Assinatura do médico patologista</div>
        </div>
        <div style="text-align: right; margin-top: 30px; display: flex; flex-direction: column; align-items: center;">
            <div id="data">Natal {{ \Carbon\Carbon::now()->format('d') }}
