...
@section('conteudo')
    ...
    <div class="d-flex justify-content-start mb-3">
        <a href="{{ route('documentos_medico.index') }}" class="btn btn-outline-primary btn-md"><i class="bi bi-arrow-repeat"></i> Selecionar outro corpo</a>
    </div>
    <div id="conteudo">
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <h6 class="text-muted font-semibold">Termo de não autorização de autopsia</h6>
                                        <h6 class="font-extrabold mb-0">Termo de não autorização de autopsia do SVO.</h6>
                                    </div>
                                    <div class="col-auto float-end"
                                        style="position:absolute; right: 0; margin-top: 10px;">
                                        <button onclick="exibirModalUpload('medico', 1 , {{ $corpo->id }})" class="btn btn-primary"><i
                                            class="bi bi-upload"></i> Upload de documento</button>
                                        <a href="{{ route('documentos_medico.gerarTermoNaoAutorizacaoAutopsia', $corpo->id) }}"
                                            target="_blank" class="btn btn-primary "><i class="bi bi-download"></i> Gerar
                                            documento</a>
                                    </div>
                                    @if(App\Models\Documento::where('papel_documento', 'medico')->where('tipo_documento', 1)->where('corpo_id', $corpo->id)->count() == 0)
                                    <h5 class="text-danger" style="text-align: right; margin: 10px 0px -10px 0px"><i class="bi bi-exclamation-triangle"></i> Não assinado!</h5>
                                @else
                                    <h5 class="text-success" style="text-align: right; margin: 10px 0px -10px 0px"><i class="bi bi-check"></i> Documento assinado</h5>
                                @endif
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <h6 class="text-muted font-semibold">Formulário de encaminhamento de material para o
                                            LACEN</h6>
                                        <h6 class="font-extrabold mb-0">Formulário de encaminhamento de material para o
                                            LACEN.
                                        </h6>
                                    </div>
                                    <div class="col-auto float-end"
                                        style="position:absolute; right: 0; margin-top: 10px;">
                                        <button onclick="exibirModalUpload('medico', 2 , {{ $corpo->id }})" class="btn btn-primary"><i
                                            class="bi bi-upload"></i> Upload de documento</button>
                                        <a href="{{ route('documentos_medico_encaminhamento_lacen.info_adicional', $corpo->id) }}"
                                            target="_blank" class="btn btn-primary "><i class="bi bi-download"></i> Gerar
                                            documento</a>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <h6 class="text-muted font-semibold">Ficha Inca</h6>
                                        <h6 class="font-extrabold mb-0">Ficha de notificação de câncer.</h6>
                                    </div>
                                    <div class="col-auto float-end"
                                        style="position:absolute; right: 0; margin-top: 10px;">
                                        <button onclick="exibirModalUpload('medico', 10 , {{ $corpo->id }})" class="btn btn-primary"><i
                                            class="bi bi-upload"></i> Upload de documento</button>
                                        <a href="{{ route('documentos_medico.fichaIncaInfoAdicional', $corpo->id) }}" class="btn btn-primary "><i class="bi bi-download"></i> Gerar
                                            documento</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <h6 class="text-muted font-semibold">TERMO DE RECONHECIMENTO DE CADÁVER</h6>
                                        <h6 class="font-extrabold mb-0">TERMO DE RECONHECIMENTO DE CADÁVER DO SVO.</h6>
                                    </div>
                                    <div class="col-auto float-end"
                                        style="position:absolute; right: 0; margin-top: 10px;">
                                        <button onclick="exibirModalUpload('medico', 1 , {{ $corpo->id }})" class="btn btn-primary"><i
                                            class="bi bi-upload"></i> Upload de documento</button>
                                        <a href="{{ route('documentos_medico.gerarTermoReconhecimentoCadaver', $corpo->id) }}"
                                            target="_blank" class="btn btn-primary "><i class="bi bi-download"></i> Gerar
                                            documento</a>
                                    </div>
