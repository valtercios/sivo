...
<head>
    ...
    <title>DECLARAÇÃO DE POSSE DO CORPO</title>
...
<body>
    <div id="main">
        ...
        <div class="subtitulo">
            <h4>DECLARAÇÃO DE POSSE DO CORPO</h4>
        </div>
        ...
        <div id="conteudo">
            ...
            <p>
                Declaro, para o devidos fins que se fizerem necessários, que se encontra no Serviço de Verificação de Óbitos, o corpo do Sr.(a) <strong>{{ $corpo->nome }}</strong>, falecido(a) no dia: {{ \Carbon\Carbon::parse($corpo->data_obito)->format('d/m/Y') }}
            </p>
