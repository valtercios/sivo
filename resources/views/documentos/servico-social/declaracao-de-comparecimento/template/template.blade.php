...
<body>
    <div id="main">
        ...
        <div id="conteudo">
            <p>
                Declaramos para os devidos fins que se fizeram necessários que o(a) Sr.(a): <strong>{{ $corpo->responsavelCorpo->nome ?? $corpo->responsavelEntrega->nome }}</strong>, portador do R.G: <strong>{{ $corpo->responsavelCorpo->rg ?? $corpo->responsavelEntrega->rg }}</strong>
					compareceu ao Serviço de Verificação de Óbitos(SVO) para tratar da liberação do corpo de: <strong> {{ $corpo->nome }} </strong>
            </p>
