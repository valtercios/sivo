        ...
        <div id="conteudo">
            ...
            <div style="font-weight: bold">
                NOME: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 51.5%; font-weight: normal; position: relative; top: 5px;">
                    {{ $corpo->nome }}</h4>
                IDADE: <h4 class="linha-campo"
            ...
            <div style="font-weight: bold">
                ...
                LOCAL: <h4 class="linha-campo"
                    style=" font-weight: bold;display:inline-block; width: 35%; font-weight: normal; position: relative; top: 5px;">
                ...
                HORA: <h4 class="linha-campo"
                    style=" font-weight: bold;display:inline-block; width: 5%; font-weight: normal; position: relative; top: 5px;">
                    {{ \Carbon\Carbon::parse($corpo->data_obito)->format('H:i') }}</h4>
            </div>
            <div style="font-weight: bold">
                MÃE: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 86.5%; font-weight: normal; position: relative; top: 5px;">
                    {{ $corpo->entrevistaInfo->mae }}</h4>
            </div>
            <div style="font-weight: bold">
                NATURALIDADE: <h4 class="linha-campo"
                    style=" font-weight: bold;display:inline-block; width: 10%; font-weight: normal; position: relative; top: 5px;">
                    {{ $corpo->entrevistaInfo->naturalidade }}</h4>
                OCUPAÇÃO: <h4 class="linha-campo"
                    style=" font-weight: bold;display:inline-block; width: 48%; font-weight: normal; position: relative; top: 5px;">
            ...
            <div style="font-weight: bold">
                ENDEREÇO: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 47.5%; font-weight: normal; position: relative; top: 5px;">
            ...
            <div style="font-weight: bold">
                D. NASC.: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 8.5%; font-weight: normal; position: relative; top: 5px;">
                    {{ \Carbon\Carbon::parse($corpo->data_nascimento)->format('d/m/Y') }}</h4>
                CPF: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 26.5%; font-weight: normal; position: relative; top: 5px;">
                    {{ $corpo->cpf ?? 'Não possui' }}</h4>
                RG: <h4 class="linha-campo"
                    style="font-weight: bold; display:inline-block; width: 26.5%; font-weight: normal; position: relative; top: 5px;">
                    {{ $corpo->rg ?? 'Não possui' }}</h4>
            </div>
            <br>
            <br>
            ...
            <div class="titulo"
                style=" margin-top: 30px;border-top: 3px solid black; text-align: left; border-bottom:none;">
                PATOLOGISTA RESPONSÁVEL - {{ $corpo->laudoInfo->medico->name ?? '' }}
            </div>
            <div
